// ============================================================
// AtendeLab - public/assets/js/api.js
// Ponte entre as telas e o backend PHP.
// Envia GET/POST, converte FormData para x-www-form-urlencoded
// e interpreta a resposta JSON.
// ============================================================
...
window.AtendeLabApi = (() => {
    ...
    function showAlert(id, message, type = 'success') {
        ...
        if (!element) return;
        element.innerHTML = `<div class="alert alert-${escape(type)} alert-dismissible fade show" role="alert">
            ${escape(message)}
